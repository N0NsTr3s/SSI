...
bool call_kernel_function(void* kernel_function_address)
{
	...
	PVOID* function = reinterpret_cast<PVOID*> (get_system_module_export("\\SystemRoot\\System32\\drivers\\dxgkrnl.sys", "NtQuerySystemInformation"));
	...
	//Easy Anticheat scanning for this code right here, if we can change the signature of this code right here we can avoid being detected
